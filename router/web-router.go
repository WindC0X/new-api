...
func SetCreativeRouter(router *gin.Engine) {
	...
	{
		creativeChatRelayRouter := creativeRelayRouter.Group("")
		creativeChatRelayRouter.Use(middleware.CreativeRelaySessionBroker(), middleware.Distribute())
		creativeChatRelayRouter.POST("/chat/completions", controller.CreativeRelayChatCompletions)
		creativeChatRelayRouter.POST("/chat/completions/", creativeRouteNotFound)

		creativeImageSyncRelayRouter := creativeRelayRouter.Group("")
		creativeImageSyncRelayRouter.POST("/images/generations", controller.CreativeRejectManagedImageBindingSyncRoute(), middleware.CreativeRelaySessionBroker(), middleware.Distribute(), controller.CreativeRelayImagesGenerations)
		...
		creativeImageTaskRelayRouter.GET("/:task_id/content", controller.CreativeRelayImageTaskContent)
		creativeImageTaskRelayRouter.POST("/", creativeRouteNotFound)
		creativeImageTaskRelayRouter.GET("/:task_id/", creativeRouteNotFound)
		creativeImageTaskRelayRouter.GET("/:task_id/content/", creativeRouteNotFound)
