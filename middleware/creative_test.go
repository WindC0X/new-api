...
func TestCreativeOriginIgnoresForwardedProtoAndHost(t *testing.T) {
	gin.SetMode(gin.TestMode)
	recorder := httptest.NewRecorder()
	ctx, _ := gin.CreateTestContext(recorder)
...
func TestCreativeOriginIgnoresStandardForwardedProto(t *testing.T) {
	gin.SetMode(gin.TestMode)
	recorder := httptest.NewRecorder()
	ctx, _ := gin.CreateTestContext(recorder)
	...
	ctx.Request.Header.Set("Referer", "http://console.example/creative/")
...
func TestCreativeOriginIgnoresFirstForwardedProtoValue(t *testing.T) {
	gin.SetMode(gin.TestMode)
	recorder := httptest.NewRecorder()
	ctx, _ := gin.CreateTestContext(recorder)
	ctx.Request = httptest.NewRequest(http.MethodGet, "http://console.example/creative/api/bootstrap", nil)
